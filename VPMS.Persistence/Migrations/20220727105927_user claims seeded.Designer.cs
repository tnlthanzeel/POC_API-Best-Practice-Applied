...
namespace VPMS.Persistence.Migrations
{
    ...
    [Migration("20220727105927_user claims seeded")]
    partial class userclaimsseeded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VPMS.Domain.Entities.IdentityUserEntities.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NormalizedEmail = "ADMIN@VPMS.COM",
            ...
            modelBuilder.Entity("VPMS.Domain.Entities.IdentityUserEntities.UserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VPMS.Domain.Entities.TodoItemEntities.TodoItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("VPMS.Domain.Entities.IdentityUserEntities.UserRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("VPMS.Domain.Entities.IdentityUserEntities.ApplicationUser", null)
                        .WithMany()
